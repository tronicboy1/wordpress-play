...
function register_wc_scripts()
{
  ...
  wp_register_script('wc-svelte-posts', $url . 'wc-svelte-posts.js', [], '0.0.0', true);
  wp_register_script('wc-lit-todos', $url . 'wc-lit-todos.js', [], '0.0.0', true);
  wp_register_script('wc-lit-websocket', $url . 'wc-lit-websocket.js', [], '0.0.0', true);
}
